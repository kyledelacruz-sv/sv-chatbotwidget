        ...
        <div className="chatbot-window open">
          ...
          <div className="chatbot-input-area">
            <label className="chatbot-attach-button">
              ...
              <input type="file" accept=".csv, .txt, .xlsx, .xls" onChange={handleFileSelect} style={{ display: 'none' }} disabled={loading} />
            </label>
            <input className="chatbot-input" value={input} onChange={handleInputChange} onKeyDown={handleKeyDown} placeholder="Type your question..." disabled={loading} />
            <button onClick={sendMessage} className="chatbot-send-button" disabled={loading}>➤</button>
          </div>
        </div>
      ) : (
        <button
